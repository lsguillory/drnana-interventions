...
const Contact = () => {
 return (
  ...
  <form action="https://formspree.io/lsg@timbuktuacadame.org" method="POST" className={styles.form}>
  <div>
  <label htmlFor='name'>name</label>
  <input type='text' name='name' id='name' className={styles.formControl} placeholder='jane smith' />
  </div>
  <div>
